...
<div class="section">
 ...
 <a href="http://fkgrt.knu.ua/osvita/subjects/components.php" class="item__title">Обов'язкові та вибіркові&nbsp; освітні компоненти (Загальні компетентності для всіх ОПП)&nbsp;</a>
			</div>
		</div>
	</div>
	<div class="list">
 ...
 <img alt="img" src="http://fkgrt.knu.ua/images/special3.jpg">
			...
			<div class="item__body">
 <a href="http://fkgrt.knu.ua/osvita/subjects/maintenance.php" class="item__title">Технічне ослуговування та ремонт геофізичної, радіоелектронної апаратури&nbsp; та комп'ютерної техніки</a>
			</div>
		</div>
		<div class="item">
			<div class="item__image">
